...
public class PullInteraction : XRBaseInteractable
{
    ...
    public void Release()
    {
        ...
        pullAmount = 0f;
        notch.transform.localPosition = new Vector3(notch.transform.localPosition.x, notch.transform.localPosition.y, 0.17f);
        UpdateString();
    ...
    private void UpdateString()
    {
        ...
        notch.transform.localPosition = new Vector3(notch.transform.localPosition.x, notch.transform.localPosition.y, linePosition.z + 0.37f);
